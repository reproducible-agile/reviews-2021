...
retrieve_authors <- function(id, submission_id) {
  ...
  authors_doc <- xml_new_root(xml_dtd(name = "html", external_id = "-//W3C//DTD XHTML 1.0 Transitional//EN", system_id = "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"))
  ...
  xml2::write_html(authors_doc, authors_html_path)
  authors_html_path
}

#retrieve_authors(review_files[1,]$id, review_files[1,]$submission_id)

for(i in c(1:nrow(review_files))) {
  retrieve_authors(review_files[i,]$id, review_files[i,]$submission_id)
}
```
