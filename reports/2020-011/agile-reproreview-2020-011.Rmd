...
> _Tobias Werner and Thomas Brinkhoff: Window Operators for Processing Spatio-Temporal Data Streams on Unmanned Vehicles. AGILE GiScience Ser., 1, 20. https://doi.org/10.5194/agile-giss-1-20-2020, 2020. _
...
osfr::osf_upload(x = project,
                 conflicts = "overwrite",
                 path = c(list.files(here::here("2020-011"), pattern = "(pdf$|Rmd$|png$)", full.names = TRUE) #,
