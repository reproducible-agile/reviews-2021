...
With the range configuration as above, the following command creates 500 `nnn_routes.geojson` files and takes a few minutes to run.
...
Now the travel times and distances are exported to a CSV file:
...
**Figure A2** was not reproduced as suitable sample needs to be seleted manually.
